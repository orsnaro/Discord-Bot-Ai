...
#(DONE)TODO : Edit your gemini args and prompt to send full arabic query to gemini/deepseek/gpt (gemini now has arabic lang suuport )

#TODO : Documentation for functions / classes and repo readme.md
...
#TODO : OOP it more and handle errors & organize commands!
#TODO : save last conversation id (load it in init_bot.py) in text file/db and add command to start new conv or  default is to continue old
#TODO : add read text in audio feature and ability for bot to join voice chat
#TODO : (discord API doesn't have this yet) ADD voice to text feature to enable full voice chat feature between bot and island server's users
...
#NOTE : the rest of tasks is on mod's channel 'todo' in my narol's server + (to find more  TODO s search via global vs code search )
